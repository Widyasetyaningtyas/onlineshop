...
<head>
  ...
  <title>ARBRE DESIGN CO | DETAIL KATEGORI</title>
  <!-- Template CSS -->
			...
			<div class="head">
                ...
                <div class="container">
                    <div class="row">
                    	...
                    	<div class="col-md-6">
                            <img src="{{ asset($kategori->gambar)}}" alt="" class="img-fluid">
                        </div>
                        <div class="col-md-6">
                            <h3 class="mt-4 mt-md-0 mb-4 mb-md-4"><span class="lohny" style="font-family: Roboto Slab; text-align: center;"><strong><center>{{$kategori->nama_kategori}} </center></strong></span></h3>
                            <p class="mb-md-5" style="font-family: Noto Serif;">{{$kategori->deskripsi_kategori}}</p>
                        </div>
								...
								<div class="col-lg-3 col-6 product-incfhny mt-4">
									<div class="product-grid2 transmitv">
										<div class="product-image2">
											<a href="#">
												<img class="pic-1 img-fluid" src="{{ asset($data->gambar1)}}">
												<img class="pic-2 img-fluid" src="{{ asset($data->gambar2)}}">
											</a>
										...
										<div class="product-content">
											<h3 class="title"><a href="#" style="text-decoration:none;">{{$data->nama_barang}}</a></h3>
