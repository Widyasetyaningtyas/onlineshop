            ...
            <div class="row justify-content-center">
                ...
                <div class="card-body" style="margin-top: -15px;">
                    ...
                    <label for="" style="font-size: 13pt; letter-spacing: 1px; font-family: FontAwesome;">Confirm Password</label>
                        <div class="inputBox">
                            <input type="password" name="password_confirmation mt-2" id="password_confirm" class="form-control" style="height: 35px; font-size: 13pt; letter-spacing: 0.5px; font-family: Raleway-SemiBold; border-radius: 30px;">
