<?php namespace App\Http\Controllers;
	...
	class AdminProductController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"ID Product","name"=>"id"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'ID Product','name'=>'id','type'=>'text','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Kategori ID','name'=>'kategori_id','type'=>'text','validation'=>'required','width'=>'col-sm-9'];
			...
			$this->form[] = ['label'=>'Stok','name'=>'stok','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10','help'=>'File types support : JPG, JPEG, PNG, GIF, BMP'];
			$this->form[] = ['label'=>'Berat','name'=>'berat','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Gambar1','name'=>'gambar1','type'=>'upload','validation'=>'required|image|max:3000','width'=>'col-sm-10'];
			...
			//$this->form[] = ['label'=>'Berat','name'=>'berat','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10','help'=>'File types support : JPG, JPEG, PNG, GIF, BMP'];
			//$this->form[] = ['label'=>'Gambar1','name'=>'gambar1','type'=>'upload','validation'=>'required|image|max:3000','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Gambar2','name'=>'gambar2','type'=>'upload','validation'=>'required','width'=>'col-sm-9'];
			# OLD END FORM
